...
export const PROJECTION_SHORTCUTS_LINE =
  '← → Space: Layer | D: Done | S: Show done | H: HUD | C: Crosshairs | X: Grid | K: Mask mode | I: Invert | L: Pure mask | O: Outline | [ ]: Opacity | − +: Scale 5% | Shift − +: Fine 1% | F: Final | G: Original | R: Registration | B/W: Screen | E: End lasso | Enter: Close lasso | Esc: Cancel/Close'
...
export const PROJECTION_SHORTCUTS_LINES: string[] = [
  ...
  '[ ] opacity · − + scale 5% · Shift − + fine 1% · F final · G original · R registration',
